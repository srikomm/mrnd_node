//Learn how to declare variables and how to use typeof operator to find the type of variable.
...
// learn how to create objects as well explore typeof/instanceof operators.

exports.Objects = function () {
    console.log("\nJavascript.Tutorials Objects");

    const p = new Person("Bill", "Gates");
    console.log("\nvalue of object p is: ", p);
    console.log("Type of object p is: ", typeof (p));
...
exports.Serialization = function () {
    ...
    const person2 = JSON.parse(str); // parses str and creates an object.
